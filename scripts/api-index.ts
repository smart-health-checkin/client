...
export const API_GROUPS: ApiGroup[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { name: "parseWalletRequest", what: "Read the SMART request from the Digital Credentials API argument." },
      { name: "ParsedWalletRequest", what: "The request and the wire pieces needed to answer it." },
      { name: "sealWalletResponse", what: "Sign and encrypt a response for the EHR's origin." },
  ...
  },
  {
    ...
    entries: [
      { name: "validateSmartCheckinRequest", what: "Validate a request." },
      { name: "validateSmartCheckinResponse", what: "Validate a response." },
      { name: "validateResponseAgainstRequest", what: "Cross-check a response against its request." },
