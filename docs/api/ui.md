...
Defined in: node\_modules/@angular/core/types/\_chrome\_dev\_tools\_performance-chunk.d.ts:829

###### Inherited from

```ts
HTMLElementBase.__jsaction_fns
```
...
```ts
HTMLElementBase.accessKeyLabel
```
...
```ts
HTMLElementBase.ariaActiveDescendantElement
```
...
```ts
HTMLElementBase.ariaAutoComplete
```
...
```ts
HTMLElementBase.ariaBrailleLabel
```
...
```ts
HTMLElementBase.ariaBrailleRoleDescription
```
...
```ts
HTMLElementBase.ariaColIndexText
```
...
```ts
HTMLElementBase.ariaControlsElements
```
...
```ts
HTMLElementBase.ariaDescribedByElements
```
...
```ts
HTMLElementBase.ariaDescription
```
...
```ts
HTMLElementBase.ariaDetailsElements
```
...
```ts
HTMLElementBase.ariaErrorMessageElements
```
...
```ts
HTMLElementBase.ariaFlowToElements
```
...
```ts
HTMLElementBase.ariaKeyShortcuts
```
...
```ts
HTMLElementBase.ariaLabelledByElements
```
...
```ts
HTMLElementBase.ariaMultiSelectable
```
...
```ts
HTMLElementBase.ariaOrientation
```
...
```ts
HTMLElementBase.ariaOwnsElements
```
...
```ts
HTMLElementBase.ariaPlaceholder
```
...
```ts
HTMLElementBase.ariaRoleDescription
```
...
```ts
HTMLElementBase.ariaRowIndexText
```
...
```ts
HTMLElementBase.ATTRIBUTE_NODE
```
...
```ts
HTMLElementBase.attributeStyleMap
```
...
```ts
HTMLElementBase.autocapitalize
```
...
```ts
HTMLElementBase.childElementCount
```
...
```ts
HTMLElementBase.contentEditable
```
...
```ts
HTMLElementBase.currentCSSZoom
```
...
```ts
HTMLElementBase.DOCUMENT_FRAGMENT_NODE
```
...
```ts
HTMLElementBase.DOCUMENT_POSITION_CONTAINED_BY
```
...
```ts
HTMLElementBase.DOCUMENT_POSITION_CONTAINS
```
...
```ts
HTMLElementBase.DOCUMENT_POSITION_DISCONNECTED
```
...
```ts
HTMLElementBase.DOCUMENT_POSITION_FOLLOWING
```
...
```ts
HTMLElementBase.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC
```
...
```ts
HTMLElementBase.DOCUMENT_POSITION_PRECEDING
```
...
```ts
HTMLElementBase.DOCUMENT_TYPE_NODE
```
...
```ts
HTMLElementBase.ENTITY_REFERENCE_NODE
```
...
```ts
HTMLElementBase.firstElementChild
```
...
```ts
HTMLElementBase.isContentEditable
```
...
```ts
HTMLElementBase.lastElementChild
```
...
```ts
HTMLElementBase.nextElementSibling
```
...
```ts
HTMLElementBase.onanimationcancel
```
...
```ts
HTMLElementBase.onanimationend
```
...
```ts
HTMLElementBase.onanimationiteration
```
...
```ts
HTMLElementBase.onanimationstart
```
...
```ts
HTMLElementBase.onbeforetoggle
```
...
```ts
HTMLElementBase.oncanplaythrough
```
...
```ts
HTMLElementBase.oncontextrestored
```
...
```ts
HTMLElementBase.ondurationchange
```
...
```ts
HTMLElementBase.onfullscreenchange
```
...
```ts
HTMLElementBase.onfullscreenerror
```
...
```ts
HTMLElementBase.ongotpointercapture
```
...
```ts
HTMLElementBase.onloadedmetadata
```
...
```ts
HTMLElementBase.onlostpointercapture
```
...
```ts
HTMLElementBase.onpointercancel
```
...
```ts
HTMLElementBase.onpointerenter
```
...
```ts
HTMLElementBase.onpointerleave
```
...
```ts
HTMLElementBase.onpointerrawupdate
```
...
```ts
HTMLElementBase.onsecuritypolicyviolation
```
...
```ts
HTMLElementBase.onselectionchange
```
...
```ts
HTMLElementBase.ontransitioncancel
```
...
```ts
HTMLElementBase.ontransitionend
```
...
```ts
HTMLElementBase.ontransitionrun
```
...
```ts
HTMLElementBase.ontransitionstart
```
...
```ts
HTMLElementBase.onvolumechange
```
...
```ts
HTMLElementBase.onwebkitanimationend
```
...
```ts
HTMLElementBase.onwebkitanimationiteration
```
...
```ts
HTMLElementBase.onwebkitanimationstart
```
...
```ts
HTMLElementBase.onwebkittransitionend
```
...
```ts
HTMLElementBase.previousElementSibling
```
...
```ts
HTMLElementBase.writingSuggestions
```
...
```ts
HTMLElementBase.attachInternals
```
...
```ts
HTMLElementBase.checkVisibility
```
...
```ts
HTMLElementBase.compareDocumentPosition
```
...
```ts
HTMLElementBase.computedStyleMap
```
...
```ts
HTMLElementBase.getAttributeNames
```
...
```ts
HTMLElementBase.getAttributeNode
```
...
```ts
HTMLElementBase.getAttributeNodeNS
```
...
```ts
HTMLElementBase.getAttributeNS
```
...
```ts
HTMLElementBase.getBoundingClientRect
```
...
```ts
HTMLElementBase.getClientRects
```
...
```ts
HTMLElementBase.getElementsByClassName
```
...
```ts
HTMLElementBase.getElementsByTagName
```
...
```ts
HTMLElementBase.getElementsByTagNameNS
```
...
```ts
HTMLElementBase.hasAttributeNS
```
...
```ts
HTMLElementBase.hasPointerCapture
```
...
```ts
HTMLElementBase.insertAdjacentElement
```
...
```ts
HTMLElementBase.insertAdjacentHTML
```
...
```ts
HTMLElementBase.insertAdjacentText
```
...
```ts
HTMLElementBase.isDefaultNamespace
```
...
```ts
HTMLElementBase.lookupNamespaceURI
```
...
```ts
HTMLElementBase.querySelectorAll
```
...
```ts
HTMLElementBase.releasePointerCapture
```
...
```ts
HTMLElementBase.removeAttribute
```
...
```ts
HTMLElementBase.removeAttributeNode
```
...
```ts
HTMLElementBase.removeAttributeNS
```
...
```ts
HTMLElementBase.removeEventListener
```
...
```ts
HTMLElementBase.replaceChildren
```
...
```ts
HTMLElementBase.requestFullscreen
```
...
```ts
HTMLElementBase.requestPointerLock
```
...
```ts
HTMLElementBase.scrollIntoView
```
...
```ts
HTMLElementBase.setAttributeNode
```
...
```ts
HTMLElementBase.setAttributeNodeNS
```
...
```ts
HTMLElementBase.setAttributeNS
```
...
```ts
HTMLElementBase.setPointerCapture
```
...
```ts
HTMLElementBase.toggleAttribute
```
...
```ts
HTMLElementBase.webkitMatchesSelector
```
...
Defined in: [src/ui/picker-element.ts:56](https://github.com/smart-health-checkin/client/blob/main/src/ui/picker-element.ts#L56)
