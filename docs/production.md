...
- Install a release by its URL, which never changes: `npm install https://github.com/smart-health-checkin/client/releases/download/v0.2.1/smart-health-checkin-client-0.2.1.tgz`. Each [release](https://github.com/smart-health-checkin/client/releases) lists its own.
